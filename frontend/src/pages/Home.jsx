...
export default function Home() {
  ...
  return (
    <div className="dashboard-page" style={{ maxWidth: 1100, margin: '0 auto' }}>
      <div className="eyebrow">AI-Powered Tournament Intelligence</div>
      <h1 style={{ fontSize: 'clamp(34px, 5vw, 58px)', lineHeight: 1.02 }}>
        PressureLab AI <span style={{ color: 'var(--accent-cyan)' }}>team intelligence</span>
      </h1>
      <p style={{ color: 'var(--text-secondary)', maxWidth: 640, fontSize: 16 }}>
        Decode every World Cup team's possession value by score state, pressure response, and
        tournament survival profile.
      </p>
